...
| Spine (from page count) | **0.3873 in** | **0.6080 in** |
| Full cover wrap | 17.6373 × 11.2500 in | 18.6830 × 12.4170 in |
...
trim edge, on any of the 172 pages:
...
| Blank pages flagged | No. There are 12 deliberate blanks: a book of two-page spreads needs each game to start on a left-hand page, and part titles open on the right. |
...
| Page size mismatch | Would be a real problem. All 172 pages are exactly 8.5 × 11 in. |
...
3. **A spread with two diagrams — for example Alquerque, pages 88–89.** Confirm
   ...
   clipped.
4. **The board templates (from page 150).**
...
- **Hardcover geometry was confirmed at a different page count.** KURUCU EYLEMİ: gerçek sayfa sayısı (172) KDP hesaplayıcısına girilen değerden (186) FARKLI. Hesaplayıcıyı yeni sayfa sayısıyla YENİDEN çalıştır ve project_config.json § hardcoverConfirmedTemplate'i güncelle — bu geometri bayat olabilir. Re-run the KDP Print Cover Calculator at the current page count before generating hardcover artwork.
- **A+ images: 1 missing.**
...
| | paperback | hardcover |
|---|---|---|
| Full wrap | 17.6373 × 11.2500 in | 18.6830 × 12.4170 in |
| Spine | 0.3873 in | 0.6080 in |
| Artwork | 5291 × 3375 px @ 300 ppi | 5605 × 3725 px |
| Type | vector, not rasterised | same |

1. **The spine.** It is 0.387 in — a thin spine, and the title is set at
