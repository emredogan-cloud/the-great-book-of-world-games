...
| Spine (from page count) | **0.4099 in** | **0.6080 in** |
| Full cover wrap | 17.6599 × 11.2500 in | 18.6830 × 12.4170 in |
...
trim edge, on any of the 182 pages:
...
| Page size mismatch | Would be a real problem. All 182 pages are exactly 8.5 × 11 in. |
...
- **Hardcover geometry is confirmed, not derived.** The spine, wrap and hinge above were confirmed directly from KDP (KDP Print Cover Calculator (kdp.amazon.com/cover-calculator) · 186 sayfa · 2026-09-17), not computed from a formula. Re-confirm only if the page count changes from 186.
- **A+ images: 1 missing.**
...
| | paperback | hardcover |
|---|---|---|
| Full wrap | 17.6599 × 11.2500 in | 18.6830 × 12.4170 in |
| Spine | 0.4099 in | 0.6080 in |
| Artwork | 5298 × 3375 px @ 300 ppi | 5605 × 3725 px |
| Type | vector, not rasterised | same |

1. **The spine.** It is 0.410 in — a thin spine, and the title is set at
