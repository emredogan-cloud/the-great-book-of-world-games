...
| Volume | 63 game entries · 2,808 words of front matter · 2,453 words of family openers |
...
(`01_SOURCE/source_verification.json`, 94 entries) in which each
...
**reconstructed** — 12 of 63 entries are.
...
This distinction matters and is easy to get wrong. The 121 board diagrams
and the 14 full-size boards
